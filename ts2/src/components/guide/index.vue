<template>
<Page :title="$t('m.guide')" class="flex v" borderLine padding routerBack="/cjs" >
    <div class="guide-right-btn" slot="layer-right-btn" v-if="finishBtn">{{$t('m.finish')}}</div>
    <div class="guide flex flex1 vc hc v re">
        <span v-if="!show" class="n-btn re-close">{{$t('m.exitguide')}}</span>
        ...
        <div class="guide-banner shadow">
            ...
            <div class="gb-bd">
                ...
                :height="`${isMobile ? '350px' : '250px'}`" arrow="never" 
                @change="change" indicator-position="none" 
                :loop='false' :autoplay="false">
                    <el-carousel-item key="1">
                        <div class="flex gb sb">
                            <div>
                                <div class="tcolor" v-html="$t('m.guide1')">
                    ...
                    <el-carousel-item key="2">
                        <div class="flex gb sb">
                            <div class="w340">
                                <div class="tcolor" v-html="$t('m.guide3')">
                                </div>
                    ...
                    <el-carousel-item key="3">
                        <div class="flex gb sb">
                            <div class="tcolor w380" v-html="$t('m.guide5')">
                            </div>
                            <div>
        ...
        <div v-show="show" v-if="!isMobile" class="finish-btn cj-btn-rw tcolor n-btn center" >{{$t('m.finishexit')}}</div>
    </div>
</Page>
</template>
<script>
