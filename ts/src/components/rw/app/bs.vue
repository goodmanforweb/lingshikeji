    ...
    methods: {
        signHandler(alldata) {
            ...
            if(!Object.keys(data).length) {
                ...
                d.presell = util.dropHex(d.presell, d.decimals,4);
                d.this_week_presell = util.dropHex(d.this_week_presell, d.decimals,4);
                d.chubeitotal = Big(d.presell).plus(d.this_week_presell).toNumber();
